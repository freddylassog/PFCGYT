...
export async function generarReporte(d: Datos): Promise<Buffer> {
  ...
  const ev: (string | number)[][] = [['Código', 'Evento', 'Institución', 'Tipo', 'Convenio', 'Estado', 'Fecha', 'Fechas y horarios', 'Horas', 'Estudiantes solicitados', 'Confirmados', 'Vestimenta', 'Alimentación', 'Transporte', 'Lugar', 'Responsable', 'Teléfono responsable', 'Fecha pedido', 'Evidencia', 'Estudiantes confirmados', 'Novedades']];
  ...
  hoja(wb, 'Eventos', ev, [14, 34, 28, 9, 13, 10, 11, 40, 7, 10, 11, 24, 12, 11, 32, 26, 16, 11, 28, 40, 40]);

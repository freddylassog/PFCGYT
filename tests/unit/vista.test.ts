...
function datosDemo(): Datos {
  return {
    ...
    ajustes: { periodo: '2026-2', inicioSemestre: '2026-09-07', semanas: 16, horasSemana: 20, correoDecanato: '', correoGrupoEstudiantes: '', correoCoordinacion: '', matrizEnviada: {}, archivos: {}, telegramChatId: '', telegramChatNombre: '', telegramCanalId: '', telegramCanalNombre: '', ultimoRecordatorio: '', telegramBotUsername: '', telegramWebhookUrl: '', uniformeLugar: '' },
    pedidos: [

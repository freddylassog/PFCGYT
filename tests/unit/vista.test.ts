...
function datosDemo(): Datos {
  return {
    ...
    pedidos: [
      { id: 'p1', periodo: '2026-2', numero: 1, codigo: 'SOL-2026-001', nombre: 'Ana', cargo: 'Dir.', institucion: 'UTE', correoSolicitante: 'a@ute.edu.ec', tipo: 'interno', convenio: 'si', evento: 'Incorporación', fecha: '2026-09-11', inicio: '15:00', fin: '18:00', dias: [{ fecha: '2026-09-11', inicio: '15:00', fin: '18:00' }], lugar: 'Auditorio', lejos: false, responsable: 'Sec.', cantidad: 2, actividades: ['Guía de invitados'], vestimenta: 'uniforme', evidenciaPath: null, evidenciaNombre: null, estado: 'Aprobado', convocadaAt: '2026-09-02', clave: 'UTE-4K7Q', createdAt: '2026-09-01T10:00:00Z' },
      { id: 'p2', periodo: '2026-2', numero: 2, codigo: 'SOL-2026-002', nombre: 'Luis', cargo: 'Coord.', institucion: 'Embajada', correoSolicitante: null, tipo: 'externo', convenio: 'no', evento: 'Recepción', fecha: '2026-09-18', inicio: '17:00', fin: '21:00', dias: [{ fecha: '2026-09-18', inicio: '17:00', fin: '21:00' }, { fecha: '2026-09-19', inicio: '09:00', fin: '12:00' }], lugar: 'Cumbayá', lejos: true, responsable: 'M.', cantidad: 4, actividades: [], vestimenta: 'formal', evidenciaPath: null, evidenciaNombre: null, estado: 'Pendiente', convocadaAt: null, clave: null, createdAt: '2026-09-06T10:00:00Z' },
    ],
    estudiantes: [

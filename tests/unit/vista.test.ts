...
function datosDemo(): Datos {
  return {
    ...
    ajustes: { periodo: '2026-2', inicioSemestre: '2026-09-07', semanas: 16, horasSemana: 20, correoDecanato: '', correoGrupoEstudiantes: '', correoCoordinacion: '', matrizEnviada: {}, archivos: {}, telegramChatId: '', telegramChatNombre: '', telegramCanalId: '', telegramCanalNombre: '', ultimoRecordatorio: '', telegramBotUsername: '', telegramWebhookUrl: '' },
    pedidos: [
      ...
      { id: 'p2', periodo: '2026-2', numero: 2, codigo: 'SOL-2026-002', nombre: 'Luis', cargo: 'Coord.', institucion: 'Embajada', correoSolicitante: null, tipo: 'externo', convenio: 'no', evento: 'Recepción', fecha: '2026-09-18', inicio: '17:00', fin: '21:00', dias: [{ fecha: '2026-09-18', inicio: '17:00', fin: '21:00' }, { fecha: '2026-09-19', inicio: '09:00', fin: '12:00' }], lugar: 'Cumbayá', lejos: true, responsable: 'M.', responsableTelefono: '', cantidad: 4, actividades: [], reparto: [], vestimenta: 'formal', evidenciaPath: null, evidenciaNombre: null, estado: 'Pendiente', convocadaAt: null, clave: null, telegramPostAt: null, createdAt: '2026-09-06T10:00:00Z' },
    ],
    estudiantes: [
